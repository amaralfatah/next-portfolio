    ...
    <div className="flex flex-col gap-16">
      <div className="flex flex-col gap-8">
        ...
        <div className="job-content flex flex-col gap-6 text-muted-foreground">
          <p>I currently edit all of my videos by myself. I'm looking for someone who can help me edit on a
            regular basis.</p>
          <p>I'm aiming for 2-4 videos per month where you'd have a minimum of 1 week to edit the thumbnail.</p>
