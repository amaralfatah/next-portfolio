      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="job-content flex flex-col gap-6 text-muted-foreground">
          <p>I currently design all of my thumbnails by myself. I&apos;m looking for someone who can help me design on a
            regular basis.</p>
          <p>I&apos;m aiming for 2-4 thumbnails per month where you&apos;d have a minimum of 1 week to design the
            thumbnail.</p>
          ...
          <p>This is a contrast position and you&apos;ll be paid a flat fee per video. We can also discuss a percentage
            of
          ...
          <p>If you&apos;re a good fit we&apos;ll schedule a call and plan a trial run of 1-2 videos (that will be
            paid).</p>
        </div>
      </div>
    </div>
